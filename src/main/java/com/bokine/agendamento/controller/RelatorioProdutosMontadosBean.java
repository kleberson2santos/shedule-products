...
@Named
@RequestScoped
public class RelatorioProdutosMontadosBean implements Serializable {
	...
	public void emitir() {
		...
		ExecutorRelatorio executor = new ExecutorRelatorio("/relatorios/relatorio_produtos_montados.jasper",
				this.response, parametros, "Produtos Montados.pdf");
